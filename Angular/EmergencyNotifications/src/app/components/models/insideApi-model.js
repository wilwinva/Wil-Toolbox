...
/**
 * @ngdoc service
 * @name enApp.service:enApiModel
 * @description
 * enApi Model of the enApp
 */
    .service('insideApiModel', ['$q', '$http', '$timeout', '$cookies', 'ENV',
        function InsideApiModel($q, $http, $timeout, $cookies, ENV) {
            var insideApiModel = this;
            /**
             * @ngdoc method
             * @name enApiModel.fetch
             * @methodOf enApp.service:enApiModel
